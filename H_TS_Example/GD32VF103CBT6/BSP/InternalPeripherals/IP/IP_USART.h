 ...
 * @LastEditTime: 2022-01-13 19:58:39
...
//获取发送dma实例
#define cIP_USART_txDMA(ip_usart)  ((ip_usart)->Instance.DMA_Tx->Instance.Channel)

//获取接收dma实例
#define cIP_USART_rxDMA(ip_usart)  ((ip_usart)->Instance.DMA_Rx->Instance.Channel)

//获取usart实例
#define cIP_USART_UASRT(ip_usart)  ((ip_usart)->Instance._USART)
