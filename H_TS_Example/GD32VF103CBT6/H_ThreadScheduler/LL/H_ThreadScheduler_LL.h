 ...
 * @LastEditTime: 2022-01-12 22:31:37
...
#define oH_TS_CompileBarrier()                                     asm volatile("":::"memory")

//数据内存屏障指令 该宏应该自带编译顺序屏蔽
//#define oH_TS_DataMemoryBarrier()                                  asm volatile("fence":::"memory");

//数据同步屏障指令 该宏应该自带编译顺序屏蔽
//#define oH_TS_DataSynchronizationBarrier()                         asm volatile("fence":::"memory");

//指令同步屏障指令 该宏应该自带编译顺序屏蔽
//#define oH_TS_InstructionSynchronizationBarrier()                  asm volatile("fence.i":::"memory");
...
#define oH_TS_CallScheduleISR()                                   do{\
                                                                    ...
                                                                    ((volatile Huint32*)(TIMER_CTRL_ADDR+TIMER_MSIP))[0]=0x00000001U;\
                                                                    oH_TS_CompileBarrier();\
                                                                  }while(0)
...
do{\
  ...
  _H_TS_GetDT_nowT=(H_TS_Time)(mtime_lo()>>5);\
