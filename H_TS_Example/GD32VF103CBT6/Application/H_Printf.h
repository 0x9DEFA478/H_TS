 ...
 * @LastEditTime: 2021-12-09 17:21:24
...
extern _H_Printf _H_Printf_USART;
...
//格式化打印到串口 仅能在线程中使用
#define H_Printf_USART(Format,...)              H_Printf_USART_CallAfterFormat(\
                                                  H_StringFormat(\
                                                    H_Printf_USART_CallBeforeFormat()\
                                                    ,Format,##__VA_ARGS__))

//C标准格式化输出 到串口 仅能在线程中使用
#define Printf_USART(Format,...)                H_Printf_USART_CallAfterFormat(\
                                                  H_sprintf(\
                                                    H_Printf_USART_CallBeforeFormat()\
                                                    ,Format,##__VA_ARGS__))
...
//默认打印调用
#define H_Printf                                H_Printf_USART

#define Printf                                  Printf_USART
