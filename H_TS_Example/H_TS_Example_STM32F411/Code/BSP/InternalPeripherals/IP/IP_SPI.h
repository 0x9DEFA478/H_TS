 ...
 * @LastEditTime: 2021-10-30 21:47:41
...
//获取发送dma实例
#define cIP_SPI_txDMA(ip_spi) ((ip_spi)->Instance.DMA_Tx->Instance.Stream)

//获取接收dma实例
#define cIP_SPI_rxDMA(ip_spi) ((ip_spi)->Instance.DMA_Rx->Instance.Stream)
