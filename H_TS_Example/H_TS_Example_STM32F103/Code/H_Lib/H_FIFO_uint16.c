 ...
 * @LastEditTime: 2022-01-11 20:06:21
...
#define cH_FIFO_uint16_GetPacketSize(_Size,_Buffer)               do{\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[0]=(_Buffer)[0];\
                                                                  }while(0)
#define cH_FIFO_uint16_SetPacketSize(_Buffer,_Size)               do{\
                                                                    (_Buffer)[0]=((H_FIFO_uint16_Type*)&(_Size))[0];\
                                                                  }while(0)
#elif H_FIFO_SizeOfSizeType == 4
#define cH_FIFO_uint16_GetPacketSize(_Size,_Buffer)               do{\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[0]=(_Buffer)[0];\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[1]=(_Buffer)[1];\
                                                                  }while(0)
#define cH_FIFO_uint16_SetPacketSize(_Buffer,_Size)               do{\
                                                                    (_Buffer)[0]=((H_FIFO_uint16_Type*)&(_Size))[0];\
                                                                    (_Buffer)[1]=((H_FIFO_uint16_Type*)&(_Size))[1];\
                                                                  }while(0)
#elif H_FIFO_SizeOfSizeType == 8
#define cH_FIFO_uint16_GetPacketSize(_Size,_Buffer)               do{\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[0]=(_Buffer)[0];\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[1]=(_Buffer)[1];\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[2]=(_Buffer)[2];\
                                                                    ((H_FIFO_uint16_Type*)&(_Size))[3]=(_Buffer)[3];\
                                                                  }while(0)
#define cH_FIFO_uint16_SetPacketSize(_Buffer,_Size)               do{\
                                                                    (_Buffer)[0]=((H_FIFO_uint16_Type*)&(_Size))[0];\
                                                                    (_Buffer)[1]=((H_FIFO_uint16_Type*)&(_Size))[1];\
                                                                    (_Buffer)[2]=((H_FIFO_uint16_Type*)&(_Size))[2];\
                                                                    (_Buffer)[3]=((H_FIFO_uint16_Type*)&(_Size))[3];\
                                                                  }while(0)
#else
#error "请选择可用的位宽"
#endif
